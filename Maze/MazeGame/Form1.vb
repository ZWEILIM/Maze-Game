Public Class Form1
    ...
    Private Sub Finish_MouseEnter(sender As Object, e As EventArgs) Handles Finish.MouseEnter
        ...
        'show dialog box and close the window
